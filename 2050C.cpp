...
void solve() {
    ...
    if(dif == 0) {
        cyes;
    } else if(dif == 1 && (to >= 4 || (to >= 1 && th >= 1))) {
        cyes;
    } else if(dif == 2 && (to >= 8 || (to >= 5 && th >= 1) || (to >= 2 && th >= 2))) {
        cyes;
    } else if(dif == 3 && (to >= 3 || th >= 1)) {
        cyes;
    } else if(dif == 4 && (to >= 7 || (to >= 4 && th >= 1) || (to >= 1 && th >= 2))) {
        cyes;
    } else if(dif == 5 && to >= 2) {
        cyes;
    } else if(dif == 6 && (to >= 6 || (to >= 3 && th >= 1) || th >= 2)) {
        cyes;
    } else if(dif == 7 && to >= 1) {
        cyes;
    } else if(dif == 8 && (to >= 5 || (to >= 2 && th >= 1))) {
        cyes;
    } else {
        cno;
    }
