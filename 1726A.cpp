...
void solve() {
    ...
    ll ans2 = (*max_element(a.begin()+1, a.end()) - a[0]);
    ll ans3 = (a[n-1] - *min_element(a.begin(), a.end()-1));
    // ll ans4 = abs(maxel(a) - minel(a));
    ll ans5 = (a[n-1] - a[0]);

    ll ans = max({ans1, ans2, ans3, ans5});
    if(n == 1) { ans = 0; }
