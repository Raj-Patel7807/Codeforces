...
bool compbyss(pair<int, int>& a, pair<int, int>& b) { if(a.second == b.second) { return a.first < b.first; } return a.second < b.second; }
...
void solve() {
    ...
    ll mn1 = minel(a), sum1 = accumulate(all(a), 0LL);
    ll mn2 = minel(b), sum2 = accumulate(all(b), 0LL);

    cout << min(n*mn1 + sum2, n*mn2 + sum1) << endl;
}
