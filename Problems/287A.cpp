...
inline void solve(ll tt) {
    ...
    fo(i, 0, 3) {
        fo(j, 0, 3) {
            if(j != 0 && i!= 0 && s[i][j] == '#' && s[i][j-1] == '#' && s[i-1][j] == '#') {
                YES();
                done;
            } else if(j != 3 && i != 3 && s[i][j] == '#' && s[i][j+1] == '#' && s[i+1][j] == '#') {
                YES();
                done;
            } else if(j != 0 && i != 3 && s[i][j] == '#' && s[i][j-1] == '#' && s[i+1][j] == '#') {
                YES();
                done;
            } else if(j != 3 && i != 0 && s[i][j] == '#' && s[i][j+1] == '#' && s[i-1][j] == '#') {
                YES();
                done;
            } else if(i != 0 && j != 0 && s[i][j] == '.' && s[i][j-1] == '.' && s[i-1][j] == '.') {
                YES();
                done;
            } else if(i != 3 && j != 3 && s[i][j] == '.' && s[i][j+1] == '.' && s[i+1][j] == '.') {
                YES();
                done;
            } else if(i != 3 && j != 0 && s[i][j] == '.' && s[i][j-1] == '.' && s[i+1][j] == '.') {
                YES();
                done;
            } else if(i != 0 && j != 3 && s[i][j] == '.' && s[i][j+1] == '.' && s[i-1][j] == '.') {
                YES();
                done;
            }
        }
